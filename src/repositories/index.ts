import type { DailyMealSummary, Food, MealRecord, WorkoutPlan, WorkoutCheckin, BodyMetric, Recommendation } from '../domain/types';
...
export class RecommendationRepository extends InMemoryRepository<Recommendation> {}
